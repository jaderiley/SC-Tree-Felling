...
const CONFIG = {
  ...
  // ─── BUSINESS INFO ───────────────────────────────────────
  business: {
    name:      "SC Tree Felling",
    phone:     "+27 74 434 0843",
    whatsapp:  "+27 74 434 0843",
    address:   "64A 1st Rd, Sandton, South Africa",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "SC Tree Felling — Tree felling in sandton",
    description: "SC Tree Felling provides professional tree felling in Sandton. 1 Google review. Call for a quote today.",
  ...
  // ─── CONTENT ─────────────────────────────────────────────
  content: {
    eyebrow:    "Tree felling · Sandton & surrounds",
    heroTitle:  "Safe tree felling — <em>from assessment to clean-up.</em>",
    heroLead:   "SC Tree Felling handles tree felling, stump removal and trimming across Sandton and the surrounding suburbs. Professional equipment, safe teams, clean site.",
    ...
    band: {
      ...
      alt:   "SC Tree Felling team at work in Sandton",
      text:  "Safe, efficient tree felling — from assessment to clean-up."
    },

    // ─── AREAS BLURB ───────────────────────────────────────
    areasTitle: "Based in Sandton. Covering the wider area.",
    areasLead:  "We work across Sandton, Fourways, Midrand and the surrounding suburbs. Emergency callouts for storm damage handled as quickly as possible.",
